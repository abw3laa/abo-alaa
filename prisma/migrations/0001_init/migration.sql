-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'PRODUCT_MANAGER', 'ORDER_MANAGER', 'CONTENT_EDITOR', 'CUSTOMER_SUPPORT', 'ANALYST', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "CustomerTier" AS ENUM ('NEW', 'REGULAR', 'VIP');

-- CreateEnum
CREATE TYPE "PublishStatus" AS ENUM ('PUBLISHED', 'DRAFT', 'ARCHIVED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_CONFIRMED', 'ORDER_STATUS', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'BACK_IN_STOCK', 'LOW_STOCK', 'PROMOTION', 'ABANDONED_CART', 'GENERAL');
...
CREATE TABLE "ShippingZone" (
    ...
    "perKgCost" DECIMAL(12,2) NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "ShippingZone" ADD CONSTRAINT "ShippingZone_carrierId_fkey" FOREIGN KEY ("carrierId") REFERENCES "ShippingCarrier"("id") ON DELETE CASCADE ON UPDATE CASCADE;
